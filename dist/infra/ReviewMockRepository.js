...
var ReviewBuilder_1 = __importDefault(require("../domain/ReviewBuilder"));
var ReviewMockRepository = /** @class */ (function () {
    function ReviewMockRepository() {
    }
    ReviewMockRepository.prototype.getAllLecture = function () {
        var lectureList = [
    ...
    ReviewMockRepository.prototype.getAllReview = function () {
        var reviewList = [
            new ReviewBuilder_1.default().reviewId("1").lectureId("136418").rate(5).contents("너무 유익한 강의였습니다.").regDate("20200924").writeId("1").writeNm("줌바줌바").build(),
            new ReviewBuilder_1.default().reviewId("2").lectureId("136418").rate(4.5).contents("좋아요~~~").regDate("20200924").writeId("2").writeNm("줌바조아").build(),
            new ReviewBuilder_1.default().reviewId("3").lectureId("138038").rate(5).contents("한국 무용 최고!!").image1("https://i.ytimg.com/vi/xy760oeu7HA/maxresdefault.jpg").regDate("20200924").writeId("3").writeNm("무용고수").build()
        ];
        return reviewList;
    };
    ReviewMockRepository.prototype.getReviewByLectureId = function (lectureId) {
        var reviewList = this.getAllReview();
        var resultReviewArr = reviewList === null || reviewList === void 0 ? void 0 : reviewList.filter(function (review) { return review.lectureId === lectureId; });
        return resultReviewArr;
    };
    ReviewMockRepository.prototype.getReviewByTutorId = function (tutorId) {
        var reviewList = this.getAllReview();
        var lectureIds = this.getLectureIdByTutorId(tutorId);
        var tutorAllReviewArr = reviewList === null || reviewList === void 0 ? void 0 : reviewList.filter(function (review) {
            return lectureIds.filter(function (lectureId) { return lectureId === review.lectureId; });
        });
     ...
     * @param tutorId
     */
    ReviewMockRepository.prototype.getLectureIdByTutorId = function (tutorId) {
    ...
    return ReviewMockRepository;
}());
exports.default = ReviewMockRepository;

...
class SearchMockEngine implements SearchEngine{
    ...
    getAllLecture():Array<Lecture> {
        ...
        let lectureList:Array<Lecture> = [
            ...
            , new Lecture("139245", "[할인]저녁 줌바 피트니스 댄스 (목)20:00",	"20200903",	"20201126",	"2000", "2050", "금", "Y", "접수중", "00002", "자녀", "000020", "엄마랑 아기랑(0~4세)인지/표현", "00002", "제주점", "2000", "1000", 16, [new LectureCurriculum("1일차", "1일차 내용"), new LectureCurriculum("2일차", "2일차 내용")])
            , new Lecture("139246", "[할인]저녁 줌바 피트니스 댄스 (월)20:00",	"20200907",	"20201123",	"2000", "2050", "토", "Y", "접수중", "00003", "기획", "000030", "임산부아카데미", "00003", "분당점", "100000", "80000", 16, [new LectureCurriculum("1일차", "1일차 내용"), new LectureCurriculum("2일차", "2일차 내용")])
            , new Lecture("139329", "[할인]줌바 피트니스 댄스(화)14:00",	"20200901",	"20201117",	"1400", "1450", "화", "Y", "접수중", "00001", "성인", "000014", "미술/서예/기악", "00002", "제주점", "50000", "12000", 16, [new LectureCurriculum("1일차", "1일차 내용"), new LectureCurriculum("2일차", "2일차 내용")])
            , new Lecture("139332", "[할인]줌바 피트니스 댄스(목)14:00",	"20200903",	"20201126",	"1400", "1450", "화", "Y", "접수중", "00001", "성인", "000011", "건강/운동", "00004", "성수점", "50000", "30000", 16, [new LectureCurriculum("1일차", "1일차 내용"), new LectureCurriculum("2일차", "2일차 내용")])
            ...
            , new Lecture("139244", "[할인]함진영의 노래교실 (수)14:00",	"20200902",	"20201125",	"1400", "1520", "수", "Y", "접수중", "00001", "성인", "000014", "미술/서예/기악", "00001", "포항이동점", "50000", "40000", 18, [new LectureCurriculum("1일차", "1일차 내용"), new LectureCurriculum("2일차", "2일차 내용")])
            ];
